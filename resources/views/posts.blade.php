<x-layout>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input name="search" autocomplete="off"
                            ...
                            placeholder="Search posts" type="text" id="search">
                    </div>
                    <div>
                        <button type="submit"
    ...
    <div class="py-6 mx-auto max-w-screen-xl">
        <div class="grid gap-4 lg:grid-cols-3">
                    ...
                    <div class="flex justify-between items-center">
                        <a href="/posts?author={{ $post->author->username }}" class="group">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="group-hover:underline font-medium dark:text-white text-sm">
                                    {{ $post->author->name }}
                                </span>
                            </div>
                        </a>
            ...
            @empty
                <div class="col-span-3 py-4 flex flex-col justify-center items-center gap-4">
                    <p class=" text-xl italic text-center">No posts found</p>
                    <a href="/posts" class="text-primary-600 hover:underline">&laquo; Back to all posts</a>
                </div>
            @endforelse
        </div>
    </div>
